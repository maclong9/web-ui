...
public struct EnhancedHTMLRenderer {
    ...
    private func generateSyntaxHighlighting(code: String, language: MarkdownRenderingOptions.SupportedLanguage)
        -> String
    {
    ...
    private func generateBasicSyntaxHighlighting(code: String, language: MarkdownRenderingOptions.SupportedLanguage)
        -> String
    {
    ...
    private func highlightSwiftSyntax(_ code: String) -> String {
        ...
        // Keywords
        let keywords = [
            "func", "var", "let", "class", "struct", "enum", "protocol", "import", "if", "else", "for", "while",
    ...
    private func highlightJavaScriptSyntax(_ code: String) -> String {
        ...
        // Keywords
        let keywords = [
            "function", "var", "let", "const", "class", "if", "else", "for", "while", "return", "import", "export",
            "async", "await",
        ]
        for keyword in keywords {
            highlighted = highlighted.replacingOccurrences(
