...
public struct EnhancedHTMLRenderer {
    ...
    public struct SyntaxHighlightInfo {
        ...
        public init(
            language: MarkdownRenderingOptions.SupportedLanguage?, fileName: String?, code: String,
    ...
    public mutating func renderWithTableOfContents(_ document: Markdown.Document) throws -> (
        html: String, tableOfContents: String
    ) {
    ...
    public mutating func visitParagraph(_ paragraph: Paragraph) throws {
        ...
        let styleClass =
            style != nil
            ? " class=\"\(MarkdownTypography.ElementType.paragraph.cssClassName)\"" : ""
    ...
    public mutating func visitLink(_ link: Markdown.Link) throws {
        ...
        let isExternal =
            escapedDestination.hasPrefix("http://") || escapedDestination.hasPrefix("https://")
        let targetAttr = isExternal ? " target=\"_blank\" rel=\"noopener noreferrer\"" : ""

        let style = typography.style(for: .link)
        let styleClass =
            style != nil ? " class=\"\(MarkdownTypography.ElementType.link.cssClassName)\"" : ""
    ...
    public mutating func visitEmphasis(_ emphasis: Markdown.Emphasis) throws {
        ...
        let styleClass =
            style != nil ? " class=\"\(MarkdownTypography.ElementType.emphasis.cssClassName)\"" : ""
    ...
    public mutating func visitStrong(_ strong: Markdown.Strong) throws {
        ...
        let styleClass =
            style != nil ? " class=\"\(MarkdownTypography.ElementType.strong.cssClassName)\"" : ""
    ...
    public mutating func visitInlineCode(_ inlineCode: InlineCode) throws {
        ...
        let styleClass =
            style != nil
            ? " class=\"\(MarkdownTypography.ElementType.inlineCode.cssClassName)\"" : ""
    ...
    public mutating func visitBlockQuote(_ blockQuote: BlockQuote) throws {
        ...
        let styleClass =
            style != nil
            ? " class=\"\(MarkdownTypography.ElementType.blockquote.cssClassName)\"" : ""
    ...
    public mutating func visitListItem(_ listItem: ListItem) throws {
        ...
        let styleClass =
            style != nil ? " class=\"\(MarkdownTypography.ElementType.listItem.cssClassName)\"" : ""
    ...
    public mutating func visitUnorderedList(_ unorderedList: UnorderedList) throws {
        ...
        let styleClass =
            style != nil
            ? " class=\"\(MarkdownTypography.ElementType.unorderedList.cssClassName)\"" : ""
    ...
    public mutating func visitOrderedList(_ orderedList: OrderedList) throws {
        ...
        let styleClass =
            style != nil
            ? " class=\"\(MarkdownTypography.ElementType.orderedList.cssClassName)\"" : ""
    ...
    public mutating func visitThematicBreak(_ thematicBreak: ThematicBreak) throws {
        ...
        let styleClass =
            style != nil
            ? " class=\"\(MarkdownTypography.ElementType.horizontalRule.cssClassName)\"" : ""
    ...
    public mutating func visitImage(_ image: Markdown.Image) throws {
        ...
        let styleClass =
            style != nil ? " class=\"\(MarkdownTypography.ElementType.image.cssClassName)\"" : ""
    ...
    public mutating func visitTable(_ table: Table) throws {
        ...
        let styleClass =
            style != nil ? " class=\"\(MarkdownTypography.ElementType.table.cssClassName)\"" : ""
    ...
    public mutating func visitTableRow(_ tableRow: Table.Row) throws {
        ...
        let styleClass =
            style != nil ? " class=\"\(MarkdownTypography.ElementType.tableRow.cssClassName)\"" : ""
    ...
    public mutating func visitTableCell(_ tableCell: Table.Cell) throws {
        ...
        let elementType: MarkdownTypography.ElementType =
            insideTableHead ? .tableHeader : .tableCell
    ...
    private func detectLanguage(from languageString: String?) -> MarkdownRenderingOptions
        .SupportedLanguage?
    {
        guard
            let lang = languageString?.lowercased().trimmingCharacters(in: .whitespacesAndNewlines)
        else {
            return nil
        }
    ...
    private func extractFileName(from languageString: String?) -> String? {
        ...
        return components.count > 1
            ? String(components[1]).trimmingCharacters(in: .whitespacesAndNewlines) : nil
    }

    /// Generates syntax highlighting HTML for code
    private func generateSyntaxHighlighting(
        code: String, language: MarkdownRenderingOptions.SupportedLanguage
    )
        -> String
    {
    ...
    private func generateBasicSyntaxHighlighting(
        code: String, language: MarkdownRenderingOptions.SupportedLanguage
    )
        -> String
    {
    ...
    private func highlightSwiftSyntax(_ code: String) -> String {
        ...
        // Keywords
        let keywords = [
            "func", "var", "let", "class", "struct", "enum", "protocol", "import", "if", "else",
            "for",
            "while",
    ...
    private func highlightJavaScriptSyntax(_ code: String) -> String {
        ...
        // Keywords
        let keywords = [
            "function", "var", "let", "const", "class", "if", "else", "for", "while", "return",
            "import",
            "export",
            "async", "await",
        ]
    ...
    private func generateCodeBlockHTML(highlightInfo: SyntaxHighlightInfo) -> String {
        ...
        if options.codeBlocks.showFileName || options.codeBlocks.copyButton
            || options.codeBlocks.runButton
        {
            ...
            if options.codeBlocks.copyButton {
                html +=
                    "<button class=\"copy-button\" type=\"button\" data-copy-text=\"\(escapeHTML(highlightInfo.code))\">"
            ...
            if options.codeBlocks.runButton && highlightInfo.language == .swift {
                html +=
                    "<button class=\"run-button\" type=\"button\" data-run-code=\"\(escapeHTML(highlightInfo.code))\">"
