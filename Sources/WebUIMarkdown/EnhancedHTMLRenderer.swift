...
public struct EnhancedHTMLRenderer {
  ...
  public mutating func visitParagraph(_ paragraph: Paragraph) throws {
    ...
    let styleClass =
      style != nil ? " class=\"\(MarkdownTypography.ElementType.paragraph.cssClassName)\"" : ""
  ...
  public mutating func visitInlineCode(_ inlineCode: InlineCode) throws {
    ...
    let styleClass =
      style != nil ? " class=\"\(MarkdownTypography.ElementType.inlineCode.cssClassName)\"" : ""
  ...
  public mutating func visitBlockQuote(_ blockQuote: BlockQuote) throws {
    ...
    let styleClass =
      style != nil ? " class=\"\(MarkdownTypography.ElementType.blockquote.cssClassName)\"" : ""
  ...
  public mutating func visitUnorderedList(_ unorderedList: UnorderedList) throws {
    ...
    let styleClass =
      style != nil ? " class=\"\(MarkdownTypography.ElementType.unorderedList.cssClassName)\"" : ""
  ...
  public mutating func visitOrderedList(_ orderedList: OrderedList) throws {
    ...
    let styleClass =
      style != nil ? " class=\"\(MarkdownTypography.ElementType.orderedList.cssClassName)\"" : ""
  ...
  public mutating func visitThematicBreak(_ thematicBreak: ThematicBreak) throws {
    ...
    let styleClass =
      style != nil ? " class=\"\(MarkdownTypography.ElementType.horizontalRule.cssClassName)\"" : ""
  ...
  private func detectLanguage(from languageString: String?) -> MarkdownRenderingOptions
    .SupportedLanguage?
  {
    guard let lang = languageString?.lowercased().trimmingCharacters(in: .whitespacesAndNewlines)
    else {
      return nil
    }
  ...
  private func highlightSwiftSyntax(_ code: String) -> String {
    ...
    // Keywords
    let keywords = [
      "func", "var", "let", "class", "struct", "enum", "protocol", "import", "if", "else", "for",
      "while",
  ...
  private func highlightJavaScriptSyntax(_ code: String) -> String {
    ...
    // Keywords
    let keywords = [
      "function", "var", "let", "const", "class", "if", "else", "for", "while", "return", "import",
      "export",
      "async", "await",
    ]
    for keyword in keywords {
