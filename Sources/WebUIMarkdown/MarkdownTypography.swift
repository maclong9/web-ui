...
public struct MarkdownTypography: Sendable {
    ...
    public struct TypographyStyle: Sendable {
        ...
        public func merging(with other: TypographyStyle) -> TypographyStyle {
            ...
            return TypographyStyle(
                ...
                customProperties: self.customProperties.merging(other.customProperties) { _, new in
                    new
                }
            )
        }
    ...
    public struct PaddingProperties: Sendable {
        ...
        public init(
            top: String? = nil, right: String? = nil, bottom: String? = nil, left: String? = nil
        ) {
            self.top = top
            self.right = right
            self.bottom = bottom
    ...
    public struct BorderProperties: Sendable {
        ...
        public init(
            width: String? = nil, style: String? = nil, color: String? = nil, radius: String? = nil
        ) {
            self.width = width
            self.style = style
            self.color = color
    ...
    public func merging(with other: MarkdownTypography) -> MarkdownTypography {
        ...
        return MarkdownTypography(
            ...
            defaultFontFamily: other.defaultFontFamily.isEmpty
                ? self.defaultFontFamily : other.defaultFontFamily,
    ...
    public func generateCSS() -> String {
        ...
        // Base font family
        cssRules.append(
            "body { font-family: \(defaultFontFamily); font-size: \(defaultFontSize.cssValue); }")
    ...
    public static func `class`(_ className: String, style: TypographyStyle) -> [String:
        TypographyStyle]
    {
        [".\(className)": style]
    }
    ...
    public static func element(_ tagName: String, style: TypographyStyle) -> [String:
        TypographyStyle]
    {
        [tagName: style]
    }
    ...
    public static let documentation = MarkdownTypography(
        ...
        elements: [
            ...
            .code: TypographyStyle(
                font: FontProperties(
                    family: "ui-monospace, Menlo, Monaco, monospace", size: .footnote),
                background: BackgroundProperties(color: "rgb(248 250 252)"),
                padding: PaddingProperties(vertical: "0.125rem", horizontal: "0.375rem"),
                border: BorderProperties(
                    width: "1px", style: "solid", color: "rgb(229 231 235)", radius: "0.25rem")
            ),
        ],
...
extension MarkdownTypography {
    ...
    @MainActor public static let article = MarkdownTypography(
        ...
        elements: [
            ...
            .blockquote: TypographyStyle(
                font: FontProperties(
                    size: .callout, color: "rgb(107 114 128)", lineHeight: .relaxed),
    ...
    @MainActor public static let blog = MarkdownTypography(
        ...
        elements: [
            ...
            .code: TypographyStyle(
                font: FontProperties(
                    family: "'Fira Code', 'SF Mono', Consolas, monospace", size: .footnote),
                background: BackgroundProperties(color: "rgb(249 250 251)"),
                padding: PaddingProperties(vertical: "0.125rem", horizontal: "0.375rem"),
                border: BorderProperties(
                    width: "1px", style: "solid", color: "rgb(229 231 235)", radius: "0.375rem")
            ),
        ],
