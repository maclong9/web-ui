...
public struct HTMLMinifier {
    ...
    private static func extractPreservedBlocks(from html: String) -> [String: String] {
            ...
            do {
                ...
                for (index, match) in matches.enumerated() {
                    if let range = Range(match.range, in: html) {
                        ...
                        let placeholder = "<!--PRESERVE_BLOCK_\(tag.uppercased())_\(index)-->"
    ...
    private static func replacePreservedBlocks(in html: String, with blocks: [String: String]) -> String {
        var result = html
    ...
    private static func normalizeWhitespace(_ html: String) -> String {
        ...
        do {
            ...
            result = multiSpaceRegex.stringByReplacingMatches(in: result, options: [], range: range, withTemplate: " ")
        } catch {
    ...
    private static func restorePreservedBlocks(in html: String, from blocks: [String: String]) -> String {
        var result = html
