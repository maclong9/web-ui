...
extension Website {
    ...
    public func build(
        ...
        if FileManager.default.fileExists(atPath: assetsURL.path()) {
            ...
            do {
                ...
                throw WebsiteBuildError.assetCopyFailed(
                    source: assetsURL.path, destination: publicURL.path)
            }
        }
    ...
    private func buildRoute(_ route: any Document, in directory: URL) throws {
        ...
        do {
            ...
            throw WebsiteBuildError.fileWriteFailed(
                path: fullPath.appending(path: "\(filename).html").path)
        }
    }
    ...
    private func generateSitemapXML(in directory: URL, baseWebAddress: String) throws {
        ...
        do {
            ...
            throw WebsiteBuildError.fileWriteFailed(
                path: directory.appending(path: "sitemap.xml").path)
        }
    }
    ...
    private func generateRobotsTxt(in directory: URL) throws {
        ...
        do {
            ...
            throw WebsiteBuildError.fileWriteFailed(
                path: directory.appending(path: "robots.txt").path)
        }
    }
}
