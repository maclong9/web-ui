...
public extension Int {
    ...
    func fraction(_ denominator: Int) -> SizingValue {
...
public extension SizingValue {
    /// Width/height set to auto
    static let auto: SizingValue = .constant(.auto)

    /// Width/height set to 1px
    static let px: SizingValue = .constant(.px)

    /// Width/height set to 100%
    static let full: SizingValue = .constant(.full)

    /// Width/height set to screen viewport
    static let screen: SizingValue = .viewport(.viewWidth)

    /// Width/height set to dynamic viewport width
    static let dvw: SizingValue = .viewport(.dynamicViewWidth)

    /// Width/height set to dynamic viewport height
    static let dvh: SizingValue = .viewport(.dynamicViewHeight)

    /// Width/height set to large viewport width
    static let lvw: SizingValue = .viewport(.largeViewWidth)

    /// Width/height set to large viewport height
    static let lvh: SizingValue = .viewport(.largeViewHeight)

    /// Width/height set to small viewport width
    static let svw: SizingValue = .viewport(.smallViewWidth)

    /// Width/height set to small viewport height
    static let svh: SizingValue = .viewport(.smallViewHeight)

    /// Width/height set to min-content
    static let min: SizingValue = .content(.min)

    /// Width/height set to max-content
    static let max: SizingValue = .content(.max)

    /// Width/height set to fit-content
    static let fit: SizingValue = .content(.fit)

    // Container size presets
    static let xs3: SizingValue = .container(.threeExtraSmall)
    static let xs2: SizingValue = .container(.twoExtraSmall)
    static let xs: SizingValue = .container(.extraSmall)
    static let sm: SizingValue = .container(.small)
    static let md: SizingValue = .container(.medium)
    static let lg: SizingValue = .container(.large)
    static let xl: SizingValue = .container(.extraLarge)
    static let xl2: SizingValue = .container(.twoExtraLarge)
    static let xl3: SizingValue = .container(.threeExtraLarge)
    static let xl4: SizingValue = .container(.fourExtraLarge)
    static let xl5: SizingValue = .container(.fiveExtraLarge)
    static let xl6: SizingValue = .container(.sixExtraLarge)
    static let xl7: SizingValue = .container(.sevenExtraLarge)
}
