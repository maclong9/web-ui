...
public func modifiers(
    _ modifiers: Modifier..., @ResponsiveStyleBuilder content: () -> ResponsiveModification
)
    -> ResponsiveModification
{
...
public func modifiers(
    _ modifier1: Modifier, _ modifier2: Modifier,
...
public func modifiers(
    ...
    MultiModifierModification(
        modifiers: [modifier1, modifier2, modifier3], styleModification: content())
}
...
public func modifiers(
    ...
    MultiModifierModification(
        modifiers: [modifier1, modifier2, modifier3, modifier4], styleModification: content())
}
...
public struct ModifierGroup {
    ...
    public func callAsFunction(@ResponsiveStyleBuilder content: () -> ResponsiveModification)
        -> ResponsiveModification
    {
        MultiModifierModification(modifiers: modifiers, styleModification: content())
    }
