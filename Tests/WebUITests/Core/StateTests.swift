...
final class StateTests: XCTestCase {
    ...
    func testArrayStateGeneration() {
        ...
        XCTAssertEqual(
            state.jsVariableDeclaration, "let items = [\"apple\", \"banana\", \"cherry\"];")
    ...
    func testStringEscaping() {
        ...
        XCTAssertEqual(
            state.jsVariableDeclaration, "let text = \"Hello \\\"World\\\"\\nNew Line\";")
    }
    ...
    func testActionArrayJSCode() {
        ...
        XCTAssertEqual(
            actions.jsCode, "incrementCounter(); setMessage('Updated'); toggleIsVisible()")
    }
