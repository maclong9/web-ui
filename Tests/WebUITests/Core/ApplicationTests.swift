  ...
  func createsAndPopulatesBuildDirectory() throws {
    let app = Application(routes: [
      ...
      Document(path: "about", metadata: .init(title: "About", description: "Learn more here")) {
        Article {
          Heading(level: .level2) { "Article Heading" }
          Text { "Lorem ipsum dolor sit amet." }
        }
      },
    ])
    ...
    #expect(
      try String(
        ...
        """
        <header><span>Logo</span><nav><a href="home">Home</a><a href="about">About</a></nav></header><main><div><h1>Tagline</h1><span>Lorem ipsum dolor sit amet.</span></div></main><footer><span>Logo</span></footer>
        """)
    )
    #expect(
      try String(
