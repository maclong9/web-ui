...
final class StateIntegrationTests: XCTestCase {
    ...
    func testWebsiteWithGlobalState() throws {
        ...
        let globalStateScript = tempOutputDirectory.appendingPathComponent(
            "scripts/state-global.js")
    ...
    func testDocumentWithLocalState() throws {
        ...
        let documentStateScript = tempOutputDirectory.appendingPathComponent(
            "scripts/state-counter.js")
    ...
    func testBuildProcessWithNoState() throws {
        ...
        if scriptsExist {
            ...
            XCTAssertTrue(
                scriptFiles.isEmpty, "No state scripts should be generated when no state is defined"
            )
        }
    }
