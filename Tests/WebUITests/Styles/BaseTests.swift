...
@Suite("Base Style Tests") struct BaseStyleTests {
    ...
    func testFrameWithFixedDimensions() async throws {
        let element = TestElement(tag: "div").frame(width: .spacing(100), height: .spacing(200))
    ...
    func testFrameWithFractionalWidth() async throws {
        let element = TestElement(tag: "div").frame(width: .fraction(1, 2))
        let rendered = element.render()
    ...
    func testFrameWithIntFractionExtension() async throws {
        let element = TestElement(tag: "div").frame(width: 1.fraction(4), height: 3.fraction(4))
        let rendered = element.render()
    ...
    func testFrameWithMinMaxDimensions() async throws {
        let element = TestElement(tag: "div").frame(minWidth: .min, maxHeight: .fit)
        let rendered = element.render()
    ...
    func testFrameWithCharacterWidthAndModifier() async throws {
        let element = TestElement(tag: "div").frame(width: .character(60), on: .md)
        let rendered = element.render()
    ...
    func testFrameWithCustomDimension() async throws {
        let element = TestElement(tag: "div").frame(height: .custom("50vh"))
        let rendered = element.render()
    ...
    func testFrameWithCGFloatValues() async throws {
        let element = TestElement(tag: "div").frame(width: 120, height: 80)
        let rendered = element.render()
    ...
    func testFrameWithConvenienceExtensions() async throws {
        let element = TestElement(tag: "div").frame(
            width: 4.spacing,
            height: 2.fraction(3),
            minWidth: 30.ch
        )
    ...
    func testSizeMethodForSquareDimensions() async throws {
        let element = TestElement(tag: "div").size(.full)
        let rendered = element.render()
    ...
    func testSizeMethodWithModifiers() async throws {
        let element = TestElement(tag: "div").size(16.spacing, on: .hover, .lg)
        let rendered = element.render()
    ...
    func testSizeMethodWithDifferentValues() async throws {
        let element = TestElement(tag: "div").size(.min)
        let rendered = element.render()
        #expect(rendered.contains("class=\"size-min\""))

        let element2 = TestElement(tag: "div").size(.fraction(1, 3))
    ...
    func testAspectRatioWithCustomDimensions() async throws {
        let element = TestElement(tag: "div").aspectRatio(16, 9)
        let rendered = element.render()
    ...
    func testSquareAspectRatio() async throws {
        let element = TestElement(tag: "div").aspectRatio()
        let rendered = element.render()
    ...
    func testVideoAspectRatio() async throws {
        let element = TestElement(tag: "div").aspectRatioVideo()
        let rendered = element.render()
    ...
    func testAspectRatioWithModifiers() async throws {
        let element = TestElement(tag: "div").aspectRatio(4, 3, on: .hover)
        let rendered = element.render()
    ...
    func testFontWithSizeAndWeight() async throws {
        let element = TestElement(tag: "div").font(size: .lg, weight: .bold)
        let rendered = element.render()
    ...
    func testFontWithAlignmentAndColor() async throws {
        let element = TestElement(tag: "div").font(alignment: .center, color: .blue(._500))
        let rendered = element.render()
    ...
    func testFontWithTrackingAndLeading() async throws {
        let element = TestElement(tag: "div").font(tracking: .wide, leading: .loose)
        let rendered = element.render()
    ...
    func testFontWithDecorationAndWrapping() async throws {
        let element = TestElement(tag: "div").font(decoration: .underline, wrapping: .nowrap)
        let rendered = element.render()
    ...
    func testFontWithFamilyAndModifier() async throws {
        let element = TestElement(tag: "div").font(family: "sans", on: .hover)
        let rendered = element.render()
    ...
    func testFontWithExtraLargeSize() async throws {
        let element = TestElement(tag: "div").font(size: .xl5)
        let rendered = element.render()
    ...
    func testCursorWithPointerType() async throws {
        let element = TestElement(tag: "div").cursor(.pointer)
        let rendered = element.render()
    ...
    func testCursorWithNotAllowedAndModifier() async throws {
        let element = TestElement(tag: "div").cursor(.notAllowed, on: .focus)
        let rendered = element.render()
    ...
    func testMarginsWithDefaultLength() async throws {
        let element = TestElement(tag: "div").margins()
        let rendered = element.render()
    ...
    func testMarginsWithSpecificEdgeAndLength() async throws {
        let element = TestElement(tag: "div").margins(of: 8, at: .top, .bottom)
        let rendered = element.render()
    ...
    func testMarginsWithAuto() async throws {
        let element = TestElement(tag: "div").margins(at: .horizontal, auto: true)
        let rendered = element.render()
    ...
    func testMarginsWithAtParameterOnly() async throws {
        let element = TestElement(tag: "div").margins(at: .top)
        let rendered = element.render()
    ...
    func testMarginsWithModifier() async throws {
        let element = TestElement(tag: "div").margins(of: 6, at: .leading, on: .md)
        let rendered = element.render()
    ...
    func testPaddingWithDefaultLength() async throws {
        let element = TestElement(tag: "div").padding()
        let rendered = element.render()
    ...
    func testPaddingWithSpecificEdges() async throws {
        let element = TestElement(tag: "div").padding(of: 5, at: .vertical)
        let rendered = element.render()
    ...
    func testPaddingWithAtParameterOnly() async throws {
        let element = TestElement(tag: "div").padding(at: .horizontal)
        let rendered = element.render()
    ...
    func testPaddingWithModifier() async throws {
        let element = TestElement(tag: "div").padding(of: 3, at: .trailing, on: .hover)
        let rendered = element.render()
    ...
    func testSpacingWithDefaultLength() async throws {
        let element = TestElement(tag: "div").spacing()
        let rendered = element.render()
    ...
    func testSpacingWithHorizontalDirection() async throws {
        let element = TestElement(tag: "div").spacing(of: 6, along: .horizontal)
        let rendered = element.render()
    ...
    func testSpacingWithAlongParameterOnly() async throws {
        let element = TestElement(tag: "div").spacing(along: .vertical)
        let rendered = element.render()
    ...
    func testSpacingWithModifier() async throws {
        let element = TestElement(tag: "div").spacing(of: 2, along: .vertical, on: .lg)
        let rendered = element.render()
    ...
    func testFrameWithCharacterSizing() async throws {
        let element = TestElement(tag: "div").frame(width: .character(80))
        let rendered = element.render()
        #expect(rendered.contains("class=\"w-[80ch]\""))

        let element2 = TestElement(tag: "div").frame(width: 40.ch)
        let rendered2 = element2.render()
    ...
    func testFontWithNoProperties() async throws {
        let element = TestElement(tag: "div").font()
        let rendered = element.render()
        #expect(!rendered.contains("class="))
    }
    ...
    func testMarginsWithNilLength() async throws {
        let element = TestElement(tag: "div").margins(of: nil, at: .top)
        let rendered = element.render()
        #expect(!rendered.contains("class="))
    }
    ...
    func testPaddingWithNilLength() async throws {
        let element = TestElement(tag: "div").padding(of: nil, at: .bottom)
        let rendered = element.render()
        #expect(!rendered.contains("class="))
    }
    ...
    func testSpacingWithNilLength() async throws {
        let element = TestElement(tag: "div").spacing(of: nil, along: .vertical)
        let rendered = element.render()
        #expect(!rendered.contains("class="))
    }
}
