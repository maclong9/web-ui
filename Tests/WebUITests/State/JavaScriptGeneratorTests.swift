...
struct JavaScriptGeneratorTests {
    ...
    func buttonHandlerGeneration() {
        ...
        #expect(incrementHandler.contains("WebUIStateManager.setState('counter', (WebUIStateManager.getState('counter') || 0) + 1)"))
        
        // Test toggle handler
        #expect(toggleHandler.contains("document.getElementById('toggle-btn')"))
        #expect(toggleHandler.contains("WebUIStateManager.setState('isToggled', !WebUIStateManager.getState('isToggled'))"))
        
        // Test decrement handler
        #expect(decrementHandler.contains("document.getElementById('decrement-btn')"))
        #expect(decrementHandler.contains("WebUIStateManager.setState('counter', (WebUIStateManager.getState('counter') || 0) - 1)"))
