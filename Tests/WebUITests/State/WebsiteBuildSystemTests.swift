...
struct WebsiteBuildSystemTests {
    ...
    func websiteBuildValidHTMLFiles() throws {
        ...
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-html-test-\(UUID().uuidString)")
    ...
    func websiteBuildValidSitemap() throws {
        let website = TestWebsite()
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-sitemap-test-\(UUID().uuidString)")
    ...
    func websiteBuildValidRobotsTxt() throws {
        let website = TestWebsite()
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-robots-test-\(UUID().uuidString)")
    ...
    func websiteBuildAssetsDirectoryCopying() throws {
        let website = TestWebsite()
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-assets-test-\(UUID().uuidString)")
        let assetsDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "test-assets-\(UUID().uuidString)")
    ...
    func websiteBuildCleansOutputDirectory() throws {
        let website = TestWebsite()
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-clean-test-\(UUID().uuidString)")
    ...
    func websiteBuildNestedRoutePaths() throws {
        ...
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-nested-test-\(UUID().uuidString)")
    ...
    func websiteBuildErrorHandling() throws {
        ...
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-error-test-\(UUID().uuidString)")
    ...
    func websiteBuildSkipsFilesWithoutBaseURL() throws {
        ...
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-no-base-test-\(UUID().uuidString)")
    ...
    func websiteBuildCustomSitemapEntries() throws {
            ...
            var sitemapEntries: [SitemapEntry]? {
                [
                    SitemapEntry(
                        ...
                        lastModified: Date(timeIntervalSince1970: 1_640_995_200),  // 2022-01-01
        ...
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-custom-sitemap-test-\(UUID().uuidString)")
    ...
    func websiteBuildCustomRobotsRules() throws {
        ...
        let tempDir = FileManager.default.temporaryDirectory.appendingPathComponent(
            "build-custom-robots-test-\(UUID().uuidString)")
