...
struct CSSOutputValidationTests {
    ...
    func flexboxUtilities() {
        ...
        let flexContainer = Section(classes: [
    ...
    func typographyUtilities() {
        ...
        let text = Text(
            "Typography test", classes: ["text-lg", "font-bold", "text-center", "leading-relaxed"])
    ...
    func stateUtilities() {
        ...
        let button = Button(
            "Hover me", classes: ["bg-blue-500", "hover:bg-blue-700", "hover:scale-105"])
    ...
    func cssClassDeduplication() {
        ...
        let element = Text(
            "Test content", classes: ["p-4", "p-4", "text-blue-500", "text-blue-500"])
