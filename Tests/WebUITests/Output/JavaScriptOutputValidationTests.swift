...
struct JavaScriptOutputValidationTests {
    ...
    func stateBindingJavaScript() {
        ...
        #expect(jsOutput.contains("createState") || jsOutput.contains("setValue") || jsOutput.contains("getValue"))
    }
    ...
    func scopedStateJavaScript() {
        ...
        #expect(jsOutput.contains("createState") || jsOutput.contains("states") || jsOutput.contains("Map"))
    }
    ...
    func javaScriptSecurity() {
        let stateManager = StateManager(configuration: StateManager.StateConfiguration())
        stateManager.registerState(key: "securityTest", initialValue: "<script>alert('xss')</script>", scope: .component)
