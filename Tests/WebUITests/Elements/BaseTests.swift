...
@Suite("Base Element Tests") struct BaseTests {
  ...
  func shouldRenderImageCorrectly() {
    ...
    #expect(image == "<img src=\"hello.png\" alt=\"Hello, world!\" width=\"100\" height=\"100\">")
  }

  @Test("Videos should render correctly")
  func shouldRenderVideoCorrectly() {
    let video = Video(
      source: "hello.mp4",
      controls: true,
      autoplay: true,
    ...
    #expect(video == "<video src=\"hello.mp4\" controls autoplay loop></video>")
  }

  @Test("Audio should render correctly")
  func shouldRenderAudioCorrectly() {
    let audio = Audio(
      source: "hello.mp3",
      controls: true,
      autoplay: true,
    ...
    #expect(audio == "<audio src=\"hello.mp3\" controls autoplay loop></audio>")
  }
